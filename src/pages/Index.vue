        ...
        <main id="home">
            <section>
                <div class="inner">
                    ...
                    <p>
                        I've worked with companies such as Air New Zealand, Tesco, News UK, IBM, The Economist, and built websites for <a href="https://www.beryl.cc" target="_blank" class="external">Beryl</a> and <a href="https://www.bullboat.co.uk" target="_blank" class="external">Bullboat</a>. Alongside my freelance work, I also design and build my own ventures such as <a href="https://www.unalike.net" target="_blank" class="external">Unalike</a>.
                    </p>

                    <p>
                        But as you can see, I'm not very minimalist with my writing.
                    </p>
                </div>
            </section>
